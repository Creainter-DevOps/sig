...
return [
    'custom' => [
        ...
        'navbarType' => 'static', // options:fixed,static,hidden (note: Horizontahl-menu template only support fixed and static)
        ...
        'defaultLanguage' => 'es-PE', //set your default language Options: en(default),pt,fr,de
