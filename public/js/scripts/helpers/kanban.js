...
function initKanba( kanban_board_data  ){
...
function customstyle( kanban_board_data ){
...
*/
  ...
  var KanbanExample = new jKanban({
    ...
    click: function (el) {
      ...
      // set edit title
      $(".edit-kanban-item .edit-kanban-item-title").val(kanban_item_title);
      $(".edit-kanban-item .edit-kanban-item-description").val(kanban_item_title);
    },
  ...
  function addBloque(id , titulo ){
    KanbanExample.addBoards([{
      id: "kanban-" + id, // generate random id for each new kanban
      title: titulo   
    }]);
    var kanbanNewBoard = KanbanExample.findBoard("kanban-" + id)
  ...
  function addBloque(id , titulo ){
    KanbanExample.addBoards([{
      id: id, // generate random id for each new kanban
      title: titulo   
    }]);
    var kanbanNewBoard = KanbanExample.findBoard("kanban-" + id)
