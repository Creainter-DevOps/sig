          ...
          <div class="card-body">
            ...
            <div class="wizard-horizontal">
                <div class="row">
                      ...
                      <iframe  class="doc" src='https://view.officeapps.live.com/op/embed.aspx?src={{ config('constants.app_url') }}/static/temporal/{{ reset($workspace['paso02'])['uri'] }}?t={{time()}}' width='1366px' frameborder='0'  style="height:600px">
                              ...
                              <li class="widget-todo-item" data-id="anexo_1" >
                                <div class="widget-todo-title-wrapper d-flex justify-content-between align-items-center mb-50">
                                  ...
                                  <div class="widget-todo-item-action d-flex align-items-center">
                                    <div class="badge badge-pill badge-light-success mr-1" onclick="visualizar(this)" style="cursor:pointer;" data-url="{{ config('constants.app_url') . '/static/temporal/' . $anexo['uri'] }}?t={{time()}}"><i class="bx bx-show"></i> </div>
