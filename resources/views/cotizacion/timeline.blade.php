    ...
    <div class="card-content">
      <div class="card-body">
              ...
              <div class="modal fade text-left" id="inlineForm" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                  <div class="modal-content">
                    ...
                    <form action="/cotizacion/{{ $cotizacion->id }}/observacion" method="post">
                      {{ csrf_field() }}
        ...
        <ul class="widget-timeline">
          @foreach($cotizacion->timeline() as $c)
          <li class="timeline-items timeline-icon-success active">
            <div class="timeline-time">{{ Helper::fecha($c->created_on, true) }}</div>
              ...
              @else
                <h6 class="timeline-title">{{ $c->creado() }}:</h6>
                <div class="badge badge-light-secondary mr-1 mb-1">Ha {{ $c->evento }} la cotizacion {{ $c->texto }}</div>
              @endif
          </li>
          @endforeach
        </ul>
