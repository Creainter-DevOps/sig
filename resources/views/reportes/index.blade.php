      ...
      <div class="card bg-transparent shadow-none kb-header">
        <div class="card-content">
          <div class="card-body text-center">
            <h1 class=" mb-2 kb-title">Reportes</h1>
            <p class=" mb-3">
            ...
            <div class="card-content">
              <div class="card-body text-center">
                <a href="{{asset('page-knowledge-base/categories')}}">
                  ...
                  <h5>Empresas</h5>
                  <p class=" text-muted">Participaciones, cotizaciones y proyectos</p>
                </a>
              </div>
            </div>
          </div>
            ...
            <div class="card-content">
              <div class="card-body text-center">
                <a href="{{asset('page-knowledge-base/categories')}}">
                  ...
                  <h5>Licitaciones</h5>
                  <p class=" text-muted">Tipo de licitaciones, rechazadas, aprobadas y en participacion.</p>
                </a>
              </div>
            </div>
          </div>
