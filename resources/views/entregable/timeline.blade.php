    ...
    <div class="card-content">
      <div class="card-body">
         ...
         <div class="modal fade text-left" id="inlineForm" tabindex="-1" role="dialog"
          ...
          <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
              ...
              <form action="/contactos/{{ $contacto->id }}/observacion" method="post">
                {{ csrf_field() }}
        ...
        <ul class="widget-timeline">
          @foreach($contacto->timeline() as $c)
            ...
            <div class="timeline-time">{{ Helper::fecha($c->created_on, true) }}</div>
             ...
             @elseif(in_array($c->evento, ['accion','que_es']))
              ...
              @else
                <h6 class="timeline-title">{{ $c->creado() }}:</h6>
                <div class="badge badge-light-secondary mr-1 mb-1">Ha {{ $c->evento }} el contacto {{ $c->texto }}</div>
              @endif
            </li>
          @endforeach
        </ul>
