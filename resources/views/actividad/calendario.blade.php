  ...
  <div class="calendar-view">
    <div class="calendar-action d-flex align-items-center flex-wrap">
      ...
      <div class="dropdown d-inline mr-75">
        <button id="dropdownMenu-username" class="btn btn-action dropdown-toggle" type="button"
          data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
          <i id="userTypeIcon" class="bx bx-user"></i>
          <span id="userTypeName">Yo</span>
        </button>
        <ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="dropdownMenu-username">
        @foreach(App\User::habilitados() as $u)
          <li role="presentation">
            <a class="dropdown-menu-title dropdown-item" role="menuitem" data-action="toggle-user" data-id="{{ $u->id }}" data-name="{{ $u->usuario }}">
