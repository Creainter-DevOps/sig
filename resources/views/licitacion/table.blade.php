                ...
                <tr>
                  ...
                  @foreach($licitacion->adjuntos() as $a)
                    <li>
                      ...
                      <a target="_blank" href="http://prodcont.seace.gob.pe/alfresco/d/a/workspace/SpacesStore/{{ $a->codigoAlfresco }}/{{ str_replace(' ', '_', $a->nombreArchivo) }}?ticket={{ $token }}"><b>[Alt]</b></a>
