<div class="sidebar" style="width:max-content;">
<div class="sidebar-content email-app-sidebar d-flex">
    ...
    <div class="email-app-menu">
      <div class="form-group form-group-compose">
        <!-- compose button -->
        <button type="button" class="btn btn-primary btn-block my-2 compose-btn"> <i class="bx bx-plus"></i> Compose </button>
      </div>
  ...
  <div class="compose-new-mail-sidebar" style="display:none;">
