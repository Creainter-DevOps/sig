...
<iframe  class="doc" src='https://view.officeapps.live.com/op/embed.aspx?src=https://sig.creainter.com.pe/storage/{{ reset($workspace['documento_final']}}' width='1366px' height='623px' frameborder='0'>This is an embedded <a target='_blank' href='http://office.com'>Microsoft Office</a> document, powered by <a target='_blank' href='http://office.com/webapps'>Office Online</a>.</iframe>
                        </div>
...
function parallelStatus() {
  ...
  .then( res => {
    ...
    if(res.finished) {
      ...
      $(".blockEndProcess").find('.doc').attr('src', 'https://view.officeapps.live.com/op/embed.aspx?src=' + (res.data.url_seace));
