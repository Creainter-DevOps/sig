        ...
        <ul class="nav nav-tabs mb-2" role="tablist">
         ...
         <!-- <li class="nav-item">
              <a class="nav-link d-flex align-items-center" id="information-tab" data-toggle="tab"
                  ...
                  <i class="bx bx-info-circle mr-25"></i><span class="d-none d-sm-block">Informacion</span>
              </a>
          </li>-->
        </ul>
            ...
            <div class="media mb-2">
                ...
                <div class="media-body">
                    ...
                    <div class="col-12 px-0 d-flex">
                        <a href="#" class="btn btn-sm btn-primary mr-25">Cambiar</a>
                        <a href="#" class="btn btn-sm btn-light-secondary">ELiminar</a>
                    </div>
                </div>
            </div>
            ...
            <form novalidate>
                <div class="row">
                    ...
                    <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                        <button type="submit" class="btn btn-primary glow mb-1 mb-sm-0 mr-0 mr-sm-1">Guardar</button>
